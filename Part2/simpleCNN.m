...
%% Helper function: Visualize function for validation set
...
%% Helper function : Turn image into grayscale type
...
Simple_Net=net;
outputFile = fullfile(output_folder, "Simple_Net.mat");
save(outputFile,"Simple_Net");
